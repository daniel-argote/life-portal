...
const Health = () => {
    return (
        <div className="space-y-10">
            <header>
                <h2 className="text-5xl font-black tracking-tighter dark:text-white">Health</h2>
                <p className="text-slate-400 font-bold mt-2 uppercase tracking-widest text-[10px]">Biometrics</p>
            </header>
            <div className="bg-white dark:bg-slate-800 p-10 rounded-[3rem] border border-slate-100 dark:border-slate-700 shadow-sm flex flex-col items-center justify-center text-center h-64">
                ...
                <p className="text-slate-500 dark:text-slate-400 font-bold">Biometric feed offline.</p>
            </div>
        </div>
    );
};
