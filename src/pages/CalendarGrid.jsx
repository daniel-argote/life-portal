...
const CalendarGrid = ({ user, notify }) => {
    ...
    return (
        <PageContainer>
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-base-200 p-4 rounded-[2rem] border border-base-300 shadow-sm">
